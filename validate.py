...
bad_order = {
    ...
    "events": [
        {"seq": 0, "type": "session", "session_id": "sess-abc12345",
         "turn_id": "turn-0002abc", "version": "1.0"},
        {"seq": 1, "type": "price_comparison",
         "data": {"query_item": "butter",
                  "options": [{"citation_ref": "c1", "is_cheapest": True}],
                  "reasoning": "cheapest option"}},
        {"seq": 2, "type": "citation", "citation": {
            "ref": "c1", "store": "paknsave", "store_location": "Sylvia Park",
            "product_name": "Butter 500g", "price_nzd": "2.97",
            "unit": "500g", "on_special": False, "valid_date": "2026-07-30",
            "source": {"table": "grocery-products-dev",
...
bad_money = {
    ...
    "events": [
        {"seq": 0, "type": "session", "session_id": "sess-abc12345",
         "turn_id": "turn-0003abc", "version": "1.0"},
        {"seq": 1, "type": "citation", "citation": {
            "ref": "c1", "store": "paknsave", "store_location": "Sylvia Park",
            "product_name": "Butter 500g", "price_nzd": "2.97",
            "unit": "500g", "on_special": False, "valid_date": "2026-07-30",
            "source": {"table": "grocery-products-dev",
                       "pk": "paknsave#sylvia-park", "sk": "butter-500g"}}},
        {"seq": 2, "type": "price_comparison",
         "data": {"query_item": "butter",
                  "options": [{"citation_ref": "c1", "is_cheapest": True}],
